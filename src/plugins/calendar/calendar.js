	...
	var i18nText,
			...
			$calBase = $( "<div class='wb-clndr' role='application' aria-label='" + i18nText.calendar + "'>" +
				"<div class='cal-nav'>" +
					...
					"<div class='form-group'>" +
						"<label class='wb-inv cal-year-label'>" + i18nText.goToYear + "</label><select class='cal-year'></select>\n" +
						"<label class='wb-inv cal-month-label'>" + i18nText.goToMonth + "</label><select class='cal-month'>" +
							( function() {
								var months = "",
									m;
		...
		initCalendar = function( settings ) {
			var years = "",
				...
				calendarID = $calendarObj.parent().attr("id");
			...
			// Adding labels "for" attribute and selects "id" attribute
			if ( !$calendarObj.find( ".cal-year" ).attr( "id" ) ) {
				$calendarObj.find( ".cal-year" ).attr( "id", "cal-year-" + calendarID );
				$calendarObj.find( ".cal-year-label" ).attr( "for", "cal-year-" + calendarID );
				$calendarObj.find( ".cal-month" ).attr( "id", "cal-month-" + calendarID );
				$calendarObj.find( ".cal-month-label" ).attr( "for", "cal-month-" + calendarID );
			}
